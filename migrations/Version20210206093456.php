 ...
 */
final class Version20210206093456 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE outfit (id INT AUTO_INCREMENT NOT NULL, master_id INT NOT NULL, type VARCHAR(50) NOT NULL, color VARCHAR(20) NOT NULL, size INT NOT NULL, about LONGTEXT NOT NULL, INDEX IDX_3202960113B3DB11 (master_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
